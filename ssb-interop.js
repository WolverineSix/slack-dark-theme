...
--text: white;
--column-bg: #ae0001;
--menu-bg-hover: #0BA8CA;
--active-item: #0BA8CA;
--active-item-text: #0BA8CA;
--hover-item: #BE0002;
--text-color: #FFFFFF;
--active-presence: #0BA8CA;
--mention-badge: #0ba8ca;
}
...
.c-unified_member .presence.active {
    color: #0BA8CA !important
}
...
.upload_in_threads.has_focus .inline_message_input_container .inline_file_upload {
    background: #0BA8CA !important;
    border: 2px solid #0BA8CA !important;
    color: white !important;
}
#primary_file_button:hover {
    border: 2px solid #077f99 !important;
    background: #077f99 !important;
}
#primary_file_button {
    position: absolute;
    bottom: 1.375rem;
...
.c-button--outline:active {
box-shadow: inset 0 0 0 1px #0Ba8CA !important;
}
...
.c-message__editor__input_container {
    ...
    .p-threads_footer__input .p-message_input_field {
        border-color: transparent !important;
        background: #424242 !important; color: black !important;}
    ...
    .p-threads_footer__input .p-message_input_field.focus~.p-message_input_file_button:hover{
        border: 2px solid #077f99 !important;
        background: #077f99 !important;
    }
...
.p-threads_footer__send_button{
    background-color: #0BA8CA;
}
.c-message__editor_footer .c-button__promary{
    background-color: #0BA8CA;
}
        ...
        .thrills_purple {
            ...
            .feature_channel_browser_dropdown .show_which_channels_container .lfs_input_container .selected {
                ...
                .c-message_kit__file__meta__text {
                    ...
                    .msg_input_btn {
                        background-color: #0BA8CA !important;
                    }
                    .p-threads_footer__input--legacy .p-message_input_file_button{
                        background-color: #0BA8CA !important;
                        color: white;
